  ...
  group('AuthToken', () {
    group('BasicAuth', () {
      ...
      test('should have proper string representation', () {
        ...
        expect(auth.toString(), isNot(contains('password'))); // Should not expose password
      });
    ...
    group('BearerAuth', () {
      ...
      test('should have proper string representation', () {
        ...
        expect(auth.toString(), isNot(contains('my-jwt-token'))); // Should not expose token
      });
    ...
    group('KerberosAuth', () {
      ...
      test('should have proper string representation', () {
        ...
        expect(auth.toString(), isNot(contains('kerberos-ticket'))); // Should not expose ticket
      });
    ...
    group('CustomAuth', () {
      ...
      test('should create token map correctly', () {
        final auth = CustomAuthToken.withProperties('custom', {'key': 'value', 'another': 'data'});
        final tokenMap = auth.toAuthData();
      ...
      test('should be equal when same scheme and credentials', () {
        final auth1 = CustomAuthToken.withProperties('custom', {'key': 'value'});
        final auth2 = CustomAuthToken.withProperties('custom', {'key': 'value'});
      ...
      test('should not be equal when different credentials', () {
        final auth1 = CustomAuthToken.withProperties('custom', {'key': 'value1'});
        final auth2 = CustomAuthToken.withProperties('custom', {'key': 'value2'});
    ...
    group('factory methods', () {
      ...
      test('should create custom auth from factory', () {
        final auth = CustomAuthToken.withProperties('myscheme', {'data': 'value'});
